...
// This file is responsible for transforming node built-in __require()s in esbuild esm output to import statements. It only works with non-minified esbuild output.
