...
# This file was no longer in use anyways. You stopped using Amazon ECR because it's 5x more expensive.
#
# This file is responsible for managing a Docker image used by CICD for running unit and functional tests. 
# The image should not be built every time CICD runs! Decide if you need to build below.
set -x
