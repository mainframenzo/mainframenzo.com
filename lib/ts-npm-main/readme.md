...
Install this package globally. From a terminal, run:
    ...
    npm install -gmainframenzo/ts-npm
...
Make changes, commit changes, push changes, reinstall locally:
    ...
    git add -A; git commit -m 'Test commit'; git push -u origin main; npm uninstall -gmainframenzo/ts-npm; npm cache clear --force; npm install -gmainframenzo/ts-npm
