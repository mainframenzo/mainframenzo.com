...
# You can load this assembly file dynamically by just passing the file path around.
# In order to do that, you need some baseline assembly config. Specify that here.
