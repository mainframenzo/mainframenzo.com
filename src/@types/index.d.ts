...
declare global {
  ...
  //var is_test: boolean | undefined; @deprecated, legacy AWS deployments.
}

// FIXME need to go through here for global/module scope: https://stackoverflow.com/questions/38906359/create-a-global-variable-in-typescript
export {};