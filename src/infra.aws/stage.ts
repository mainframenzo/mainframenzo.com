...
// In our case you just deploy to main, which is syntatic sugar for creating cfn stacks (specific prefixes) that manage resources (with specific prefixes).
...
export default class AppStage extends Constructs.Construct {
  ...
  constructor(scope: Constructs.Construct, id: string, props: Props) {
    ...
    // Rely on our own cdk resources so you don't create conflicts with other cdk-based application infra.
