...
interface CfnExports {
  readonly integrationTestsFunctionARN: cdk.CfnOutput; // Exported so you can execute from the CLI (locally or during CICD).
  readonly opsDashboardARN: cdk.CfnOutput; // Exported so you can lookup to get ops dashboard URL.
}
