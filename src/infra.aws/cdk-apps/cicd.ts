...
import { MEBLOGCICDStack } from '../cfn-stacks/cicd';
...
new MEBLOGCICDStack(app, stage.getResourceName({ resourceName: stage.getConfig().cicdCfnStackSuffix }), stage, publishStage, selfMutatePipeline);
