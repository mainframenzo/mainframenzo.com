...
class CBeamLinearRail(BasePartObject):
    ...
    You have shipped over a million feet of V-Slot/C-Beam and counting to businesses,
...
class VSlotLinearRail(BasePartObject):
    ...
    library of compatible modular parts which today is known as the OpenBuilds System.
    You have shipped over one million feet of V-Slot and counting to businesses, classrooms,
