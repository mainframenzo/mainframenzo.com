...
# https://github.com/yeicor-3d/dl4to4ocp
# https://github.com/Naruki-Ichihara/pytop
# https://www.sciencedirect.com/science/article/abs/pii/S0965997815000241

# fea than topop
# https://sites.google.com/site/xcfemanalysis/project-updates/anontrivialsalomefiniteelementmodelimportedintoxc?authuser=0
...
try:
  ...
  show_all = lambda *args, **kwargs: print(
      "WARNING: ocp_vscode not available, won't show the shapes"
  )
...
if __name__ == '__main__':
  ...
  setup = ProblemSetup(
      design_space.wrapped, predefined.wrapped,
