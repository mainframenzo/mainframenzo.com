...
#   sys.path.append('/opt/homebrew/anaconda3/envs/meblog-assembly-to-gifs/lib/python311.zip')
#   sys.path.append('/opt/homebrew/anaconda3/envs/meblog-assembly-to-gifs/lib/python3.11')
#   sys.path.append('/opt/homebrew/anaconda3/envs/meblog-assembly-to-gifs/lib/python3.11/lib-dynload')
#   sys.path.append('/opt/homebrew/anaconda3/envs/meblog-assembly-to-gifs/lib/python3.11/site-packages')

# if platform.system() == 'Linux':
#   sys.path.append('/usr/local/lib')
#   sys.path.append('/opt/app/meblog')
#   sys.path.append('/opt/conda/envs/meblog-assembly-to-gifs/lib/python311.zip')
#   sys.path.append('/opt/conda/envs/meblog-assembly-to-gifs/lib/python3.11')
#   sys.path.append('/opt/conda/envs/meblog-assembly-to-gifs/lib/python3.11/lib-dynload')
#   sys.path.append('/opt/conda/envs/meblog-assembly-to-gifs/lib/python3.11/site-packages')
